  ...
  return (
    <div>
      ...
      {list.length === 0 ? (
        ...
        <div key={wd.id} style={{ ...card, marginBottom: 12 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 12 }}>
            <div>
              ...
              <div style={{ fontSize: 13, color: C.text, fontWeight: 600 }}>{wd.userName || "Player"}</div>
            </div>
          ...
          <div style={{ background: C.surface2, borderRadius: 8, padding: "8px 12px", marginBottom: wd.status === "pending" ? 12 : 0, display:"flex", alignItems:"center", justifyContent:"space-between" }}>
            <div>
              <span style={{ fontSize: 11, color: C.textFaint }}>bKash নম্বর: </span>
